...
namespace Std.BuildTools.Common.Ansi;
...
public partial struct Color
{
    ...
    /// <summary>
    /// Gets the color "LightSlateGray" (RGB 135,135,175).
    /// </summary>
    public static Color LightSlateGray { get; } = new Color(103, 135, 135, 175);
    ...
    /// <summary>
    /// Gets the color "DarkYellow" (RGB 178,178,0).
    /// </summary>
    public static Color DarkYellow { get; } = new Color(184, 178, 178, 0);
    ...
    /// <summary>
    /// Gets the color "DarkGray" (RGB 98,98,98).
    /// </summary>
    public static Color DarkGray { get; } = new Color(241, 98, 98, 98);
